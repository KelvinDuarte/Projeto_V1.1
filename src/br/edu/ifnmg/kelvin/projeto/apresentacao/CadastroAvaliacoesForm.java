 ...
 * @author KELVIN
 */
public class CadastroAvaliacoesForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CadastroAvaliacoesForm
     */
    
    public CadastroAvaliacoesForm(){
        avaliacaoEmEdicao = new Avaliacao();
        this.prepararTela();
    }
    
    public CadastroAvaliacoesForm(Avaliacao avaliacaoParaEdicao){
    ...
    public void recuperarCamposTela() throws ParseException{
        ...
        avaliacaoEmEdicao.setAltura(altura);
        double frequenciaCardiaca = Double.parseDouble(txtFrequenciaCardiaca.getText());
        avaliacaoEmEdicao.setFrequenciaCardiaca(frequenciaCardiaca);
        double pressaoArterial = Double.parseDouble(txtPressaoArterial.getText());
        avaliacaoEmEdicao.setPressaoArterial(pressaoArterial);
        double torax = Double.parseDouble(txtTorax.getText());
        avaliacaoEmEdicao.setTorax(torax);
        double cintura = Double.parseDouble(txtCintura.getText());
        avaliacaoEmEdicao.setCintura(cintura);
        double abdome = Double.parseDouble(txtAbdome.getText());
        avaliacaoEmEdicao.setAbdome(abdome);
        double quadril = Double.parseDouble(txtQuadril.getText());
        avaliacaoEmEdicao.setQuadril(quadril);
        double anteBracoEsquerdo = Double.parseDouble(txtAntebracoEsquerdo.getText());
        avaliacaoEmEdicao.setAntebracoEsquerdo(anteBracoEsquerdo);
        double anteBracoDireito = Double.parseDouble(txtAntebracoDireito.getText());
        avaliacaoEmEdicao.setAntebracoDireito(anteBracoDireito);
        double bracoEsquerdo = Double.parseDouble(txtBracoEsquerdo.getText());
        avaliacaoEmEdicao.setBracoEsquerdo(bracoEsquerdo);
        double bracoDireito = Double.parseDouble(txtBracoDireito.getText());
        avaliacaoEmEdicao.setBracoDireito(bracoDireito);
        double coxaEsquerda = Double.parseDouble(txtCoxaEsquerda.getText());
        avaliacaoEmEdicao.setCoxaEsquerda(coxaEsquerda);
        double coxaDireita = Double.parseDouble(txtCoxaDireita.getText());
        avaliacaoEmEdicao.setCoxaDireita(coxaDireita);
        double panturrilhaEsquerda = Double.parseDouble(txtPanturrilhaEsquerda.getText());
        avaliacaoEmEdicao.setPanturrilhaEsquerda(panturrilhaEsquerda);
        double panturrilhaDireita = Double.parseDouble(txtPanturrilhaDireita.getText());
        avaliacaoEmEdicao.setPanturrilhaDireita(panturrilhaDireita);
        double subscapular = Double.parseDouble(txtSubscapular.getText());
        avaliacaoEmEdicao.setSubscapular(subscapular);
        double tricipital = Double.parseDouble(txtTricipital.getText());
        avaliacaoEmEdicao.setTricipital(tricipital);
        double peitoral = Double.parseDouble(txtPeitoral.getText());
        avaliacaoEmEdicao.setPeitoral(peitoral);
        double axilarMedia = Double.parseDouble(txtAxilarMedia.getText());
        avaliacaoEmEdicao.setAxilarMedia(axilarMedia);
        double supraIliaca = Double.parseDouble(txtSupraIliaca.getText());
        avaliacaoEmEdicao.setSupraIliaca(supraIliaca);
        double abdominal = Double.parseDouble(txtAbdominal.getText());
        avaliacaoEmEdicao.setAbdominal(abdominal);
        double coxa = Double.parseDouble(txtDobraCoxa.getText());
        avaliacaoEmEdicao.setCoxa(coxa);
        int flexoes = Integer.parseInt(txtFlexoes.getText());
    ...
    public void salvarAvaliacao(){ 
        try{
            ...
            avaliacaoBO.cadastrarAvaliacao(avaliacaoEmEdicao);
            JOptionPane.showMessageDialog(this, "Avaliação cadastrada com sucesso!", "Cadastro de Avaliações", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }catch(Exception e){
            String mensagem = "Erro inesperado! Informe a mensagem de erro ao administrador do sistema.";
            mensagem += "\nMensagem de erro:\n" + e.getMessage();
            JOptionPane.showMessageDialog(this, mensagem, "Cadastro de Avaliações", JOptionPane.ERROR_MESSAGE);                              
        }
    }
    ...
    public void editarAvaliacao(){
        try{
            this.recuperarCamposTela();
            AvaliacaoBO avaliacaoBO = new AvaliacaoBO();           
            avaliacaoBO.editarAvaliacao(avaliacaoEmEdicao);
            JOptionPane.showMessageDialog(this, "Avaliação alterada com sucesso!", "Cadastro de Avaliações", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }catch(Exception e){
            String mensagem = "Erro inesperado! Informe a mensagem de erro ao administrador do sistema.";
            mensagem += "\nMensagem de erro:\n" + e.getMessage();
